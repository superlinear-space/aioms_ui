"""
Django settings for aioms_backend project.
"""
...
CORS_ALLOWED_ORIGINS = [
    f"http://localhost:{CONFIG.get('PORT', 15000)}",
    f"http://localhost:{CONFIG.get('FRONTEND_PORT', 5173)}",
    "http://localhost:3000",
]

CORS_ALLOW_CREDENTIALS = True

# Custom configuration from config.json
SUPERALARM_PATH = CONFIG.get("SUPERALARM_PATH")
SUPERALARM_TIMEOUT = CONFIG.get("SUPERALARM_TIMEOUT", 300)
DEFAULT_CLUSTER_DIR = CONFIG.get("DEFAULT_CLUSTER_DIR")
DEFAULT_OUTPUT_DIR = CONFIG.get("DEFAULT_OUTPUT_DIR")
MAX_FILE_SIZE = CONFIG.get("MAX_FILE_SIZE", 10485760)
LOG_LEVEL = CONFIG.get("LOG_LEVEL", "INFO")
PORT = CONFIG.get("PORT", 15000)
